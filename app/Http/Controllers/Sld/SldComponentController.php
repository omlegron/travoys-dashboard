...
class SldComponentController extends Controller
{
    protected $routes = 'sld.component';
    protected $link = 'sld/component/';
    ...
    {
        return $this->render('modules.sld.component.index',['mockup' => true]);
    }

    public function create()
    {
        return $this->render('modules.sld.component.create');
    }
    ...
    {
        $records = [];
        return $this->render('modules.sld.component.edit', ['record' => $records]);
    }
    ...
    public function showEditor(Request $request){
        $records = [];
        return $this->render('modules.sld.component.show', ['record' => $records]);
    }
}
