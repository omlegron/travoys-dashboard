...
class TripGangguanController extends Controller
{
    protected $routes = 'manajemen.trip-gangguan-sistem';
    protected $link = 'manajemen/trip-gangguan-sistem/';
    ...
    {
        return $this->render('modules.manajemen-data.trip-gangguan.index',['mockup' => true]);
    }

    public function create()
    {
        return $this->render('modules.manajemen-data.trip-gangguan.create');
    }
    ...
    {
        $records = [];
        return $this->render('modules.manajemen-data.trip-gangguan.edit', ['record' => $records]);
    }
    ...
    public function showEditor(Request $request){
        $records = [];
        return $this->render('modules.manajemen-data.trip-gangguan.show', ['record' => $records]);
    }

    public function createBeban()
    {
        return $this->render('modules.manajemen-data.trip-gangguan.create-sistem');
    }
}
