...
EditorUi = function(editor, container, lightbox)
{
	...
	this.container = container || document.getElementById('graphEditorArea');
	...
	if (this.container == document.getElementById('graphEditorArea'))
	{
...
EditorUi.prototype.initCanvas = function()
{
	...
	if (this.editor.isChromelessView())
	{
		...
		if (urlParams['toolbar'] != '0')
		{
			...
			if (urlParams['layers'] == '1')
			{
				...
				var layersButton = addButton(mxUtils.bind(this, function(evt)
				{
					...
					else
					{
						...
						document.getElementById('graphEditorArea').appendChild(this.layersDialog);
					}
			...
			if (graph.lightbox && (urlParams['close'] == '1' || this.container != document.getElementById('graphEditorArea')))
			{
				addButton(mxUtils.bind(this, function(evt)
				{
...
EditorUi.prototype.refresh = function(sizeDidChange)
{
	...
	if (this.container == document.getElementById('graphEditorArea'))
	{
		w = document.getElementById('graphEditorArea').clientWidth || document.documentElement.clientWidth;
		h = (quirks) ? document.getElementById('graphEditorArea').clientHeight || document.documentElement.clientHeight : document.documentElement.clientHeight;
	}
