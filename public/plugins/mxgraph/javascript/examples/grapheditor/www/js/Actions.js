...
Actions.prototype.init = function()
{
	...
	action = this.addAction('layers', mxUtils.bind(this, function()
	{
		if (this.layersWindow == null)
		{
			...
			this.layersWindow = new LayersWindow(ui, document.getElementById('graphEditorArea').offsetWidth - 280, 120, 220, 180);
	...
	action = this.addAction('outline', mxUtils.bind(this, function()
	{
		if (this.outlineWindow == null)
		{
			...
			this.outlineWindow = new OutlineWindow(ui, document.getElementById('graphEditorArea').offsetWidth - 260, 100, 180, 180);
