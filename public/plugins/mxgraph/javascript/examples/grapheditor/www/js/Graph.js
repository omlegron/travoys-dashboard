...
Graph.prototype.getPropertiesNameForCell = function(cell)
{
   if (cell.value != null && typeof(cell.value) == 'object')
   {
	   var properties = cell.value.getAttribute('properties_name');

	   // Removes links with leading javascript: protocol
	   // TODO: Check more possible attack vectors
	   if (properties != null && properties.toLowerCase().substring(0, 11) === 'javascript:')
	   {
		   properties = properties.substring(11);
	   }
...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		Graph.prototype.setPropertiesNameForCell = function(cell, name)
		{
		   this.setAttributeForCell(cell, 'properties_name', name);
		};
